...
public class Semester7 extends AppCompatActivity {
    ...
    private EditText m1,m2,m3,m4,m5,m6,m7,m8,m9;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sum = (p1*3+p2*2+p3*3+p4*2+p5*3+p6*2+p7*3+p8*1);

                CGPA = (sum/19);

                m9.setText(String.valueOf(CGPA));
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Semester7.this,Cgpacalculator.class);
